...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x06, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x32, 0x90, 0x01, 0x0a,
	0x0a, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x3e, 0x0a, 0x09, 0x41,
	0x64, 0x64, 0x62, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x0d, 0x47,
	0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x16, 0x2e, 0x70,
...
var file_blockchain_proto_depIdxs = []int32{
	...
	0, // 1: proto.Blockchain.Addbblock:input_type -> proto.AddBlockRequest
	3, // 2: proto.Blockchain.GetBlockChain:input_type -> proto.GetBlockRequest
	1, // 3: proto.Blockchain.Addbblock:output_type -> proto.AddBlockResponse
...
type BlockchainClient interface {
	Addbblock(ctx context.Context, in *AddBlockRequest, opts ...grpc.CallOption) (*AddBlockResponse, error)
...
func (c *blockchainClient) Addbblock(ctx context.Context, in *AddBlockRequest, opts ...grpc.CallOption) (*AddBlockResponse, error) {
	out := new(AddBlockResponse)
	err := c.cc.Invoke(ctx, "/proto.Blockchain/Addbblock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockchainServer interface {
	Addbblock(context.Context, *AddBlockRequest) (*AddBlockResponse, error)
...
func (*UnimplementedBlockchainServer) Addbblock(context.Context, *AddBlockRequest) (*AddBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Addbblock not implemented")
}
...
func _Blockchain_Addbblock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockchainServer).Addbblock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Blockchain/Addbblock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockchainServer).Addbblock(ctx, req.(*AddBlockRequest))
	}
...
var _Blockchain_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Addbblock",
			Handler:    _Blockchain_Addbblock_Handler,
		},
		{
